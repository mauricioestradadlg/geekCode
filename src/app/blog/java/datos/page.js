...
import img2 from '../imagenes/img16.png';
import img3 from '../imagenes/img17.png';
import img4 from '../imagenes/img18.png';
import img5 from '../imagenes/img19.png';
import img6 from '../imagenes/img20.png';
import img7 from '../imagenes/img21.png';
import img8 from '../imagenes/img22.png';
import img9 from '../imagenes/img23.png';
...
function Blog() {
  return (
    <>
      ...
      <br/><Image src={img8}  className={styles.imgInicio} alt="Java Variables" width={900} height={500} /><br/>
      ...
      <Image src={img3} className={styles.imgInicio} alt="Java Variables" width={900} height={500} /><br/>
      ...
      <Image src={img9}  className={styles.imgInicio} alt="Java Variables" width={900} height={500} /><br/><br/>
      ...
      <Image src={img5} className={styles.imgInicio} alt="Java Variables" width={900} height={500} /><br/>
      ...
      <Image src={img6} className={styles.imgInicio} alt="Java Variables" width={900} height={500} /><br/>
      ...
      <Image src={img7} className={styles.imgInicio} alt="Java Variables" width={900} height={500} /><br/>
