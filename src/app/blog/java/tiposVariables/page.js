...
function Blog(){
    ...
    <h1>TIPOS DE VARIABLES EN JAVA</h1>
      ...
      <article>
        ...
        <h3>a. Enteros</h3>
        <ul>
          <li ><p><b>Byte: </b> Representa un valor de 8 bits con signo. Rango: -128 a 127.</p></li>
          <li> <p><b>Short: </b> Representa un valor de 16 bits con signo. Rango: -32,768 a 32,767.</p></li>
          <li> <p><b>Int: </b>: Representa un valor de 32 bits con signo. Rango: -2^31 a 2^31-1.</p></li>
          <li> <p><b>Long: </b>: Representa un valor de 64 bits con signo. Rango: -2^63 a 2^63-1.</p></li>
        </ul>
        <br/><br/>
        <h3>b. Punto Flotante</h3>
        <ul>
          <li><p><b>Float: </b>: Representa un valor de punto flotante de 32 bits. Adecuado para ahorrar memoria en grandes arrays de números decimales.</p></li>
          <li><p><b>Double: </b>: Representa un valor de punto flotante de 64 bits. Es el tipo de dato para decimales más utilizado.</p></li>
        </ul>
        <br/><br/>
        <h3>c. Caracteres</h3>
        <ul>
          <li><p><b>Char: </b>: Representa un solo carácter de 16 bits. Utiliza comillas simples, por ejemplo, 'a'.</p></li>
        </ul>
        <br/><br/>
        <h3>d. Booleanos</h3>
        <ul>
          <li><p><b>Boolean: </b>: Representa un valor verdadero o falso. Solo puede tomar los valores <i>true</i> o <i>false</i>.</p></li>
        </ul>
        <br/><br/>
        ...
        <ul>
          <li><p><b>Strings</b>: Secuencias de caracteres. Java proporciona la clase <code>String</code> para trabajar con cadenas de texto.</p></li>
          <li><p><b>Arrays</b>: Colecciones de elementos del mismo tipo. Los arrays en Java son objetos que pueden almacenar múltiples valores.</p></li>
          <li><p><b>Clases</b>: Instancias de cualquier clase que crees en Java. Por ejemplo, si tienes una clase <code>Persona</code>, puedes crear una variable de referencia a una instancia de <code>Persona</code>.</p></li>
        </ul>
        <br/><br/>
